...
import * as validationUtils from '../../../components/common/validations/validationUtils';
...
export const useFormValidation = (schema, options = {}) => {
  ...
  const { formState: { errors, isValid, isDirty, touchedFields }, reset, setValue, watch, getValues } = form;
