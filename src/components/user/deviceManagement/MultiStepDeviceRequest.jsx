...
import { db, collection, addDoc, serverTimestamp } from '../../../services/firebase/firebase';
...
const MultiStepDeviceRequest = ({ onClose, onSuccess }) => {
  ...
  const validateStep1 = () => {
    ...
    } else if (!/^([0-9]{9}[vV]|[0-9]{12})$/.test(formData.nicNumber.trim())) {
      newErrors.nicNumber = 'Please enter a valid NIC number (9 digits + V/v or 12 digits)';
    }
    setErrors(newErrors);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let errorMessage = 'Failed to submit device request';
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600">Please provide your personal information</p>
      </div>
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600">Please provide information about your farm</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600">Select the parameters you want to monitor</p>
      </div>
      <div>
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900">Device Request</h2>
            <button
              onClick={onClose}
...
export default MultiStepDeviceRequest;
