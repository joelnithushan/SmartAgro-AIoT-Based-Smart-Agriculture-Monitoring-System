          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-4">
                <span className="text-3xl font-black text-green-400 tracking-wide" style={{ fontFamily: 'Poppins, sans-serif' }}>
                  SmartAgro
                </span>
              </div>
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                Revolutionizing agriculture through innovative IoT technology. Helping farmers make data-driven decisions for sustainable and profitable farming.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/about" className="text-gray-300 hover:text-green-400 transition-colors duration-200">About</Link></li>
                ...
                <li><Link to="/login" className="text-gray-300 hover:text-green-400 transition-colors duration-200">Login</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">info@smartagro.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-400 text-sm mb-4 md:mb-0">
                © 2024 SmartAgro. All rights reserved. Made with ❤️ in Sri Lanka.
              </div>
