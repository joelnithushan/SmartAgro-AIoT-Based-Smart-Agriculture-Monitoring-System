...
import RequestDeviceModal from '../components/user/deviceManagement/RequestDeviceModal';
import CostEstimationCard from '../components/common/ui/CostEstimationCard';
import DeviceStatusCard from '../components/user/dashboard/DeviceStatusCard';
import RealtimeSensorCards from '../components/user/dashboard/RealtimeSensorCards';
import WeatherSection from '../components/user/dashboard/WeatherSection';
import { useRealtimeSensorData } from '../hooks/useRealtimeSensorData';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
import { ref, onValue } from 'firebase/database';
import { database } from '../config/firebase';
import { processSensorData, generatePeriodSensorData, convertSoilMoistureToPercentage } from '../components/common/hooks/chartDataGenerator';
