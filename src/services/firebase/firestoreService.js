  ...
  async createOrUpdateUser(userId, userData) {
    try {
      ...
      if (error.code === 'permission-denied') {
        console.log('⚠️ Permission denied for user creation, continuing without saving');
        return { success: true }; // Don't treat this as a failure
      }
...
// Add the new methods to the existing usersService
usersService.getUserSettings = userSettingsService.getUserSettings;
usersService.updateUserSettings = userSettingsService.updateUserSettings;
